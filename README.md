...
[![Website](https://img.shields.io/badge/Live%20Platform-powelab.org-10b981?style=flat-square)](https://powelab.org)
...
[![OER Commons](https://img.shields.io/badge/OER%20Commons-Course%20Resource-0072CE?style=flat-square)](https://www.oercommons.org/courses/powerlab-deterministic-energy-systems-battery-storage-modeling-suite)
[![Standards](https://img.shields.io/badge/Standards-IEEE%20%7C%20NEC%20%7C%20NREL%20%7C%20ASHRAE-blue?style=flat-square)](https://powelab.org/methodology)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](LICENSE)

**PowerLab** ([powelab.org](https://powelab.org)) is an open-source, deterministic computational modeling platform designed to unify clean energy planning across:
...
| :--- | :--- |
| 🔋 **Battery Storage** | • [Battery Runtime Calculator](https://powelab.org/battery/battery-runtime-calculator) (Peukert + Inverter Tare)<br>• [Battery Size Calculator](https://powelab.org/battery/battery-size-calculator)<br>• [Battery Capacity Calculator](https://powelab.org/battery/battery-capacity-calculator)<br>• [Battery Charging Time Calculator](https://powelab.org/battery/battery-charging-time-calculator)<br>• [UPS Runtime](https://powelab.org/battery/ups-runtime-calculator) & [UPS Battery Sizing](https://powelab.org/battery/ups-battery-size-calculator)<br>• [Home Battery Size Calculator](https://powelab.org/battery/home-battery-size-calculator)<br>• [Portable Power Station Calculator](https://powelab.org/battery/portable-power-station-calculator) |
| ☀️ **Solar Photovoltaics** | • [Solar Panel Tilt Calculator](https://powelab.org/solar/solar-panel-tilt-calculator) (PVWatts V8 + Latitude Cosine Angle)<br>• [Solar Panel Output Calculator](https://powelab.org/solar/solar-panel-output-calculator)<br>• [Solar Panel Size Calculator](https://powelab.org/solar/solar-panel-size-calculator)<br>• [Solar Load Calculator](https://powelab.org/solar/solar-load-calculator)<br>• [Solar Battery Bank Sizing](https://powelab.org/solar/solar-battery-bank-size-calculator)<br>• [MPPT Solar Charge Controller Calculator](https://powelab.org/solar/solar-charge-controller-calculator)<br>• [Solar System Payback & ROI](https://powelab.org/solar/solar-payback-calculator) |
| ⚡ **Home Energy & Loads** | • [Electricity Usage Calculator](https://powelab.org/home-energy/electricity-usage-calculator)<br>• [Energy Bill Calculator](https://powelab.org/home-energy/energy-bill-calculator)<br>• [Appliance Wattage & Duty Cycle](https://powelab.org/home-energy/appliance-wattage-calculator)<br>• [Generator Sizing Calculator](https://powelab.org/home-energy/generator-size-calculator) (Motor Inrush & Starting kVA)<br>• [Air Conditioner Operating Cost Calculator](https://powelab.org/home-energy/air-conditioner-cost-calculator) (SEER2 Derating)<br>• [Heat Pump Cost & COP Calculator](https://powelab.org/home-energy/heat-pump-cost-calculator)<br>• [Space Heater Electricity Cost Calculator](https://powelab.org/home-energy/space-heater-cost-calculator) |
| 🚗 **Electric Vehicles** | • [EV Charging Time Calculator](https://powelab.org/ev/ev-charging-time-calculator) (Level 1, Level 2, DC Fast)<br>• [EV Charging Cost Calculator](https://powelab.org/ev/ev-charging-cost-calculator)<br>• [EV Range Calculator](https://powelab.org/ev/ev-range-calculator) (Aerodynamic Drag & HVAC Auxiliary Loads)<br>• [EV Fuel Savings Calculator](https://powelab.org/ev/ev-savings-calculator)<br>• [EV Charger Dedicated Breaker Sizing](https://powelab.org/ev/ev-charger-breaker-size-calculator) (NEC 625 125% Rule)<br>• [Vehicle-to-Load (V2L) Runtime Calculator](https://powelab.org/ev/v2l-runtime-calculator) |
