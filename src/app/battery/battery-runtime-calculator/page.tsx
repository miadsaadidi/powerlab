    ...
    <article className="page calculator-page">
      ...
      <section id="related-tools">
        ...
        <p style={{ marginTop: "0.75rem" }}>
          📖 <strong>In-Depth Technical Guides &amp; Empirical Data:</strong> Read our comprehensive <Link href="/guides/battery-backup-runtime-calculation-guide" style={{ fontWeight: 600, color: "var(--accent)" }}>Battery Backup Runtime Formula &amp; Inverter Loss Guide</Link>, examine our <Link href="/datasets/residential-battery-storage-degradation-and-thermal-loss-benchmark" style={{ fontWeight: 600, color: "var(--accent)" }}>Residential BESS Degradation &amp; Thermal Loss Benchmark (PL-DS-BESS-06)</Link>, or explore empirical C-rate data in our <Link href="/datasets/bess-peukert-capacity-derating-tare-loss-benchmark" style={{ fontWeight: 600, color: "var(--accent)" }}>BESS Peukert Derating Benchmark (PL-DS-BESS-05)</Link>.
        </p>
      </section>
    </article>
  );
