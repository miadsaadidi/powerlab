...
* **Step 3 (Cluster Planning Mesh & Governance Synchronization):**
  ...
  - Published and verified MERLOT OER higher-education simulation material entry `MER-06` on California State University System ([Material #824240275](https://www.merlot.org/merlot/viewMaterial.htm?id=824240275), DA 75 / DR 79, `DOFOLLOW VERIFIED`) for `/home-energy/heat-pump-cost-calculator` with full pedagogical breakdown and CC BY-NC 4.0 license metadata.
  - Published and verified technical distribution article `DEV-08` on DEV.to ([Live Article Link](https://dev.to/miad_ea7faef80e5125861119/why-heat-pump-calculations-fail-modeling-doe-appendix-m1-hspf2-derates-sub-zero-cop-decay-and-onp), DA 91 / DR 89) for *"Why Heat Pump Calculations Fail: Modeling DOE Appendix M1 HSPF2 Derates, Sub-Zero COP Decay, and Fuel Parity in TypeScript"* with verified `rel="canonical"` pointing to `/home-energy/heat-pump-cost-calculator`. Synchronized `SEO/BACKLINK_LOG.csv` and `SEO/EXTERNAL_DISTRIBUTION.md`.
